package com.stussy.stussyclone20221012lhs.dto;


import com.stussy.stussyclone20221012lhs.dto.validation.ValidationGroups;
import lombok.Data;
...
public class RegisterReqdDto {
    ...
    @Size(min= 1, max=2,message = "성은 2글자만 입력 가능합니다",groups = ValidationGroups.SizeGroup.class)
    @Pattern(regexp = "^[가-힇]*$", message = "한글만 입력 가능합니다",groups = ValidationGroups.PatternCheckGroup.class)
